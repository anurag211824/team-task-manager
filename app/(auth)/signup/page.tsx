          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="flex items-start gap-2">
                <input
                  type="checkbox"
                  className="mt-1 rounded border-gray-300 text-blue-600 focus:ring-blue-500 dark:border-gray-700"
                  required
                />
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 py-2 hover:from-blue-600 hover:to-blue-700 disabled:opacity-50"
            >
              {signup.isPending ? (
                <>
